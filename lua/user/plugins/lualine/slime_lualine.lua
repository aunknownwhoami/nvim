...
M.branch = {
  "branch",
  icons_enabled = true,
  color = { fg = color.green, bg = "#16161E" },
  icon = " ",
  separator = { right = "" },
}
...
M.filesize = {
  ...
  color = { fg = color.green, bg = "gray12" },
  separator = { left = "" },
}
...
M.progress = {
  ...
  color = { fg = color.green, bg = "#000F10" },
  separator = { left = "" },
}
...
M.total_lines = {
  ...
  separator = { left = "" },
  color = { fg = "#202328", bg = color.green },
}

M.percent = {
  "progress",
  separator = { left = "" },
  color = { fg = color.fg, bg = "gray15" },
}
