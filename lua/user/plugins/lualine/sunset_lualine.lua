...
M.total_lines = {
  ...
  separator = { left = "" },
  color = { fg = color.fg, bg = "#4D2B39" },
}

M.percent = {
  "progress",
  separator = { left = "" },
  color = { fg = color.fg, bg = "#201B20" },
}
