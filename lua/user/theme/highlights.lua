...
local highlights = {
  ...
  SignColumn = { fg = color.fg, bg = color.sunset_bg or color.slime_bg or color.night_bg or color.transparent },
  SignColumnSB = { fg = color.fg, bg = color.sunset_bg or color.slime_bg or color.night_bg or color.transparent },
  ...
  LineNr = { fg = color.dark3, bg = color.sunset_bg or color.slime_bg or color.night_bg or color.transparent },
  CursorLineNr = {
  ...
  CursorLine = { bg = color.sunset_cursor or color.slime_cursor or color.night_column or color.cursor_highlight },
  ...
  BufferLineIndicatorSelected = { fg = color.indicator or color.slime or color.sky or color.transparent_header },
  ...
  -- GitGutter
  GitGutterAdd = { fg = color.green, bg = color.sunset_bg or color.slime_bg or color.night_bg or color.transparent },
  GitGutterChange = { fg = color.blue, bg = color.sunset_bg or color.slime_bg or color.night_bg or color.transparent },
  GitGutterDelete = { fg = color.red, bg = color.sunset_bg or color.slime_bg or color.night_bg or color.transparent },
  ...
  NvimTreeWinSeparator = { fg = color.sunset_bg or color.slime_bg or color.night_bg or color.cursor_highlight },
